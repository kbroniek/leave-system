...
public class CreateModifyWorkingHoursTest
{
    ...
    Guid? workingHoursId, string? userId, DateTimeOffset? dateFrom, TimeSpan? duration, FederatedUser? createdBy)
    {
        ...
        var act = () =>
        {
            ModifyWorkingHours.Create(workingHoursId, userId, dateFrom, dateTo, duration, createdBy);
        };
        //Then
        ...
        Guid? workingHoursId, string? userId, DateTimeOffset? dateFrom, TimeSpan? duration, FederatedUser? addedBy)
    {
        ...
        var act = () =>
        {
            ModifyWorkingHours.Create(workingHoursId, userId, dateFrom, dateTo, duration, addedBy);
        };
        //Then
    ...
    public void WhenAllArgumentsCorrect_ThenCreateWithCorrectProperties()
    {
        ...
        //When
        var result = ModifyWorkingHours.Create(id, userId, dateFrom, dateTo, duration, addedBy);
        //Then
