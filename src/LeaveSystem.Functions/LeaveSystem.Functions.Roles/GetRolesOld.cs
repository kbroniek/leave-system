...
namespace LeaveSystem.Functions
{
    public class GetRolesOld
    {
        ...
        private readonly ILogger<GetRolesOld> logger;

        public GetRolesOld(ILogger<GetRolesOld> logger) => this.logger = logger;

        [Function(nameof(GetRolesOld))]
