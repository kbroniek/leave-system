...
public class UsersFunction
{
    ...
    public IActionResult GetUsers([HttpTrigger(AuthorizationLevel.Function, "get", Route = "users")] HttpRequest req)
    {
    ...
    [Authorize(Roles = $"{nameof(RoleType.GlobalAdmin)},{nameof(RoleType.UserAdmin)}")]
    public IActionResult EditUser([HttpTrigger(AuthorizationLevel.Function, "put", Route = "users/{userId:alpha}")] HttpRequest req, string userId, [FromBody] EditUserDto user)
    {
        logger.LogInformation("C# HTTP trigger function processed a request.");
    ...
    [Authorize(Roles = $"{nameof(RoleType.GlobalAdmin)},{nameof(RoleType.UserAdmin)}")]
    public IActionResult CreateUser([HttpTrigger(AuthorizationLevel.Function, "post", Route = "users")] HttpRequest req, [FromBody] CreateUserDto user)
    {
        logger.LogInformation("C# HTTP trigger function processed a request.");
    ...
    [Authorize(Roles = $"{nameof(RoleType.GlobalAdmin)},{nameof(RoleType.UserAdmin)}")]
    public IActionResult DisableUser([HttpTrigger(AuthorizationLevel.Function, "delete", Route = "users/{userId:alpha}")] HttpRequest req, string userId)
    {
        logger.LogInformation("C# HTTP trigger function processed a request.");
