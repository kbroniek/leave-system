...
public static class EnumerableExtensions
{
    ...
    public static IEnumerable<WorkingHoursDto> ToDto(this IEnumerable<WorkingHours> source) => source.Select(x => new WorkingHoursDto(x.UserId, x.DateFrom, x.DateTo, x.Duration));
}